...
const CreateNewPasswordPage = () => {
  ...
  return (
    <>
      <div className="bg-white_A700 flex flex-col font-montserrat md:gap-[40px] sm:gap-[40px] gap-[80px] items-center justify-start mx-[auto] p-[233px] sm:px-[20px] md:px-[40px] w-[100%]">
        <Text
        ...
        <div className="flex flex-col items-start justify-start md:w-[100%] sm:w-[100%] w-[33%]">
          <Text
          ...
          <Button
            className="common-pointer cursor-pointer font-bold leading-[normal] md:ml-[0] sm:ml-[0] ml-[15px] mt-[80px] sm:text-[20px] md:text-[22px] text-[24px] text-center text-white_A700 w-[290px]"
            onClick={() => navigate("/passwordresetconfirmation")}
            size="2xl"
          >
            Update Password
          </Button>
